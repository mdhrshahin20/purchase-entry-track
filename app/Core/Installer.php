...
class Installer
{
    ...
    {
        return Config::basePath('config/installed.lock');
    }
    ...
    {
        return Config::basePath('config/database.php');
    }
    ...
    {
        return Config::basePath('database/purchase_entry.sql');
    }
    ...
    /**
     * True when the current request targets the installer route.
     */
